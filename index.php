  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?metot=index">
        ...
        <div class="sidebar-brand-text mx-3">Şah Panel<sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?metot=magaza" aria-expanded="true" aria-controls="collapseTwo">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?metot=personel" aria-expanded="true" aria-controls="collapseUtilities">
